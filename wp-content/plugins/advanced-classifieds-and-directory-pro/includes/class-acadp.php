...
class ACADP {
	...
	private function load_dependencies() {
		...
		require_once ACADP_PLUGIN_DIR . 'admin/class-acadp-admin-fields-custom.php';
		...
		require_once ACADP_PLUGIN_DIR . 'public/class-acadp-public-listings-ajax.php';
		require_once ACADP_PLUGIN_DIR . 'public/class-acadp-public-prepare-html-ajax.php';
		
		require_once ACADP_PLUGIN_DIR . 'public/class-acadp-public-search.php';	
		require_once ACADP_PLUGIN_DIR . 'public/class-acadp-public-search-custom.php';
		...
		require_once ACADP_PLUGIN_DIR . 'public/class-acadp-public-registration-ajax.php';
		require_once ACADP_PLUGIN_DIR . 'public/class-acadp-public-user.php';
		require_once ACADP_PLUGIN_DIR . 'public/class-acadp-public-user-ajax.php';
	...
	private function define_admin_hooks() {
		...
		// Hooks specific to the custom post type "acadp_fields_custom"
		$plugin_admin_fields_custom = new ACADP_Admin_Fields_Custom();
		if( is_admin() ) {
			$this->loader->add_action( 'acadp-admin-filds-custom', $plugin_admin_fields_custom, 'hand_custom_filds_admin', 10, 2 );
	...
	private function define_public_hooks() {
		...
		$plugin_public_listings_ajax = new ACADP_Public_Listings_Ajax();
		$this->loader->add_action( 'wp_ajax_get_content', $plugin_public_listings_ajax, 'get_content', 10, 2 );
		$this->loader->add_action( 'wp_ajax_nopriv_get_content', $plugin_public_listings_ajax, 'get_content', 10, 2 );
		$this->loader->add_action( 'wp_enqueue_scripts', $plugin_public_listings_ajax, 'my_assets', 10, 2 );
		

		$plugin_public_prepare_html_ajax = new ACADP_Public_Prepare_Html_Ajax();
		$this->loader->add_action( 'wp_ajax_get_prepare_html', $plugin_public_prepare_html_ajax, 'get_prepare_html', 10, 2 );
		$this->loader->add_action( 'wp_ajax_nopriv_get_prepare_html', $plugin_public_prepare_html_ajax, 'get_prepare_html', 10, 2 );
		$this->loader->add_action( 'wp_enqueue_scripts', $plugin_public_prepare_html_ajax, 'add_custom_scripts', 10, 2 );
		...
		// Hooks specific to the search page (Custom fields)
		$plugin_public_search_custom = new ACADP_Public_Search_Custom();
		
		$this->loader->add_filter( 'acadp-custom-filds-search', $plugin_public_search_custom, 'hand_custom_fields_search', 10, 1 );
		...
		if( acadp_registration_enabled() ) {
			$plugin_public_registration_ajax = new ACADP_Public_Registration_Ajax();
			
			
			//$this->loader->add_action( 'wp_logout', $plugin_public_registration, 'redirect_after_logout' );
			//$this->loader->add_action( 'login_form_register', $plugin_public_registration_ajax, 'redirect_to_custom_register' );
			//$this->loader->add_action( 'login_form_lostpassword', $plugin_public_registration_ajax, 'redirect_to_custom_lostpassword' );
			//$this->loader->add_action( 'login_form_rp', $plugin_public_registration_ajax, 'redirect_to_custom_password_reset' );
			//$this->loader->add_action( 'login_form_resetpass', $plugin_public_registration_ajax, 'redirect_to_custom_password_reset' );
			
			//$this->loader->add_action( 'init', $plugin_public_registration_ajax, 'manage_actions' );
			//$this->loader->add_action( 'login_form_register', $plugin_public_registration_ajax, 'do_register_user' );
			//$this->loader->add_action( 'login_form_lostpassword', $plugin_public_registration_ajax, 'do_forgot_password' );
			//$this->loader->add_action( 'login_form_rp', $plugin_public_registration_ajax, 'do_password_reset' );
			//$this->loader->add_action( 'login_form_resetpass', $plugin_public_registration_ajax, 'do_password_reset' );
			
			//$this->loader->add_filter( 'authenticate', $plugin_public_registration_ajax, 'maybe_redirect_at_authenticate', 101, 3 );
			//$this->loader->add_filter( 'login_redirect', $plugin_public_registration_ajax, 'redirect_after_login', 10, 3 );
			//$this->loader->add_filter( 'retrieve_password_message', $plugin_public_registration_ajax, 'replace_retrieve_password_message', 10, 4 );
		}
		...
		$plugin_public_user_ajax = new ACADP_Public_User_Ajax();
		
		//$this->loader->add_action( 'init', $plugin_public_user_ajax, 'manage_actions' );
		//$this->loader->add_action( 'parse_request', $plugin_public_user_ajax, 'parse_request' );
		$this->loader->add_action( 'wp_ajax_acadp_crud', $plugin_public_user_ajax, 'manage_actions', 10, 2 );
		$this->loader->add_action( 'wp_ajax_acadp_public_custom_fields_form_ajax', $plugin_public_user_ajax, 'ajax_callback_custom_fields', 10, 2 );
		//$this->loader->add_action( 'wp_ajax_nopriv_acadp_public_custom_fields_listings', $plugin_public_user_ajax, 'ajax_callback_custom_fields', 10, 2 );
		//$this->loader->add_action( 'wp_ajax_acadp_public_image_upload', $plugin_public_user_ajax, 'ajax_callback_image_upload', 10, 2 );
		//$this->loader->add_action( 'wp_ajax_nopriv_acadp_public_image_upload', $plugin_public_user_ajax, 'ajax_callback_image_upload', 10, 2 );
		//$this->loader->add_action( 'wp_ajax_acadp_public_delete_attachment_listings', $plugin_public_user_ajax, 'ajax_callback_delete_attachment' );
		//$this->loader->add_action( 'wp_ajax_nopriv_acadp_public_delete_attachment_listings', $plugin_public_user_ajax, 'ajax_callback_delete_attachment' );
