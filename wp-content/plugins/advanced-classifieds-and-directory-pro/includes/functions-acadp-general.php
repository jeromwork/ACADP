...
function acadp_get_custom_field_types() {
	...
	$types = array(
		...
		'hidden'   => __( 'hidden', 'advanced-classifieds-and-directory-pro' ),//trrr
		'address'   => __( 'address', 'advanced-classifieds-and-directory-pro' ),//trrr
		'numeric'   => __( 'numeric', 'advanced-classifieds-and-directory-pro' ),//trrr
		'search_number_from'   => __( 'number_from', 'advanced-classifieds-and-directory-pro' ),//trrr
		'search_number_to'   => __( 'number_to', 'advanced-classifieds-and-directory-pro' )//trrr		
		/*'cell_search'   => __( 'cell_search', 'advanced-classifieds-and-directory-pro' ),//trrr
		'numeric_min'   => __( 'numeric_min', 'advanced-classifieds-and-directory-pro' ),//trrr
		'numeric_max'   => __( 'numeric_max', 'advanced-classifieds-and-directory-pro' ),//trrr
		'numeric_step'   => __( 'numeric_step', 'advanced-classifieds-and-directory-pro' ),//trrr
*/
	);
...
/**
 * Check current checkbox is groupe lable
 *
 * @since     1.6.1
 * 
 * @return    int     $can_use_yoast    "true" if can use Yoast, "false" if not.
 */
function acadp_display_checkbox_is_group($item) {
	//mb_internal_encoding("UTF-8");
	//echo substr($item, 0,1);
	if(substr($item, 0,1) == '('){		return 2;}
else if(substr($item, 0,1) == ')')	{return 1;}

	return 0;
}
function acadp_display_checkbox_to_json_parameters($item) {
	if(substr($item, 0,1) == '@'){		return json_decode(substr(htmlspecialchars_decode($item, ENT_QUOTES), 1));}


	return false;
}
function acadp_display_is_json_params($item) {
