...
jQuery(document).ready(function(){
   ...
   // $(".prepare_forms").on('acadp_prepare_html_complite', function () {  
    $("body").on("acadp_prepare_html_complite", function(){
        ...
        console.log('acadp_prepare_html_complite');
var jebm = $(".js-example-basic-multiple");
jebm.select2(
            {
               
               //placeholder:"плейсхолдер не работает",
               maximumSelectionLength:jebm.data('s2_maximum_selection_length')
    ...
    var jebs = $(".js-example-basic-single");
    jebs.select2( {
        //placeholder:jebs.data('s2-placeholder')
    });
